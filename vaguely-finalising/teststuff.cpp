...
int main(){
    ...
    coo(B,Brow,Bcolumn,Bdata,sqrt(B.size()),sqrt(B.size()));
    auto [Cindcols,Cdata]=coo_spgemm(Arow,Acolumn,Adata,sqrt(A.size()),sqrt(A.size()),Brow,Bcolumn,Bdata,sqrt(B.size()),sqrt(B.size()));
